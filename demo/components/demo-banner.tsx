  ...
  return (
    <div className="w-full bg-[color:var(--accent)] text-white border-b border-black/10">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-2 flex items-center gap-3">
        <span className="font-mono text-[10px] md:text-[11px] uppercase tracking-[0.1em] shrink-0">
          DEMO
        </span>
        <span className="text-[12px] md:text-[13px] flex-1 min-w-0 truncate md:whitespace-normal">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="hidden sm:inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.08em] hover:underline shrink-0"
        >
